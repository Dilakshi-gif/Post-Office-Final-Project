...
$sql = "SELECT * FROM money_order WHERE id = $id";
...
<div class="login">
  ...
  <form action="updateMoneyOrder.php" method="post">
    ...
    <p><input type="text" name="amount" value="<?php echo $row['amount']; ?>" placeholder="Amount"></p>

...
$moneyOrderList = "SELECT * FROM money_order";
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="adminMoneyOrder.php">Money Orders</a></li>
    ...
    <table border="1" id="customers">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" .'<a href="moneyOrderStatusUpdate.php?paymentid='.$row["id"].' "><img src="Images\swap.png" width="25" height="25" alt=""></a></br>' . $row["payment_status"] . "</td>";
                echo "<td>" .'<a href="moneyOrderStatusUpdate.php?id='.$row["id"].' "><img src="Images\swap.png" width="25" height="25" alt=""></a></br>' . $row["status"] . "</td>";

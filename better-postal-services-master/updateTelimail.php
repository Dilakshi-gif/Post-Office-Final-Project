...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE telemails SET sender_name = '$senderName', sender_address = '$senderAddress' , receiver_name = '$receiverName',receiver_address = '$receiverAddress'  WHERE id = $id";

    if ($mysqli->query($sql) === TRUE) {
        $message = " Telimail updated";

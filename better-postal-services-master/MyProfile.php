...
$userId = $_SESSION['id'];
    ...
    $telimailList = "SELECT * FROM telemails WHERE user = '$userId'";
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="MyProfile.php">My Telemails</a></li>
        <li><a href="myMoneyOrder.php">My Money Orders</a></li>
      </ul><br>
    </div>
    <br>
    
    <div class="col-sm-9">
        <div><h4><a href="#"><img src="Images\bookmark.png" width="25" height="35" alt=""></a>My Telemail Records</h4></div>
        <br>
